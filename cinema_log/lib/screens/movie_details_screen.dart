  ...
  Future<void> _loadMediaDetails() async {
    try {
      ...
      if (widget.mediaType == 'tv') {
        ...
        _providerData = await _controller.fetchProviderById(
          widget.mediaId,
          'tv',
        );
      } else {
                      ...
                      builder: (_) {
                        return SafeArea(
                          child: Column(
                            ...
                            children: [
                              if (watchStatus !=
                                  'watched') //show mark as watched option if it hasn't been watched
                                ListTile(
                                  leading: const Icon(
                              ...
                              if (watchStatus ==
                                  'watched') //show mark as unwatched option if it has been watched
                                ListTile(
                                  leading: const Icon(
                              ...
                              if (watchStatus !=
                                  'watching') //show mark as watching option if it isn't being watched
                                ListTile(
                                  leading: const Icon(
                              ...
                              if (watchStatus ==
                                  'watching') //show mark as not watching option if it is being watched
                                ListTile(
                                  leading: const Icon(
                                    Icons.play_circle_outline,
                                    color: Colors.white,
                              ...
                              if (watchStatus !=
                                  'want_to_watch') //show want to watch option if it isn't already marked as want to watch
                                ListTile(
                                  leading: const Icon(
                              ...
                              if (watchStatus ==
                                  'want_to_watch') //show remove from want to watch option if it is marked as want to watch
                                ListTile(
                                  leading: const Icon(
                                    Icons.bookmark_border,
                                    color: Colors.white,
