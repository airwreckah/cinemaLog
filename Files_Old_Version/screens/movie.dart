  ...
  void _showAddToCustomListDialog() {
    ...
    if (customLists.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Create a custom list')),
      );
      return;
    }
                  ...
                  onTap: () {
                    ...
                    final media = Media(
                      ...
                      year: movie['release_date'] != null &&
                          ...
                          ? int.tryParse(movie['release_date']
                                  .toString()
                                  .substring(0, 4)) ??
                              0
                          : 0,
...
void _toggleWatched() {
  ...
  final media = Media(
    ...
    type: 'movie',
    year: movieData['release_date'] != null &&
            movieData['release_date'].toString().length >= 4
        ? int.tryParse(movieData['release_date'].toString().substring(0, 4)) ?? 0
        : 0,
    genre: 'Unknown',
